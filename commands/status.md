...
1. Determine `<project-slug>` (stated in the milepost SessionStart context; else: git repo root of the cwd — or the cwd itself — lowercased, non-alphanumeric runs → `-`, trimmed) and locate `~/.claude/memory/milepost/<project-slug>/STATUS.md`.
